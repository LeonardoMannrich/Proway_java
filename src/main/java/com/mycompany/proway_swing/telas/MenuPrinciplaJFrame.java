 ...
 * @author 74703
 */
public class MenuPrinciplaJFrame extends javax.swing.JFrame {

    /**
     * Creates new form MenuPrinciplaJFrame
     */
    public MenuPrinciplaJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButtonFilmes.setActionCommand("jButtonFilmes");
...
form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPrinciplaJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPrinciplaJFrame().setVisible(true);
            }
        });
    }
